...
import com.hakkum.eby.BuildConfig;
...
public class ImageCache {
	...
	private static final int DEFAULT_MEM_CACHE_SIZE = 1024 * 15; // 1MB
	...
	public static class ImageCacheParams {
		 ...
		 * kilobytes instead of bytes as this will eventually be passed to construct a LruCache which takes an int in its constructor.
		 * 
